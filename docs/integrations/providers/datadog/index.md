...
There are no entities to which you can map Bugsee applications in Datadog. Instead, you will be offered with single static option of _"Events stream"_. You should select it for all the Bugsee applications you want to receive events for.
