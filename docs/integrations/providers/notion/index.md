...
There are no specific configuration steps for Notion. Refer to <a href="/integrations/configuration/">configuration</a> section for description about generic steps.
