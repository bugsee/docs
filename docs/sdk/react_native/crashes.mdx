...
We rely on source maps to fill captured stack traces with proper methods, filenames and line numbers. To let this magic happen, Bugsee needs the related source maps which are uploaded automatically once you configure your projects following instructions below.
...
> **IMPORTANT**: For release builds, we strongly recommend uploading source maps BEFORE deploying your app. That will guarantee your reports will not fail to symbolicate due to missing symbols.
...
- Deploy your app build to the target store