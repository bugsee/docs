...
To symbolicate crashes captured in native code, you should configure underlying Android and iOS projects following the instructions in the documentation for these SDKs. Refer to symbolication documentation for [Android](/sdk/android/crashes/) and [iOS](/sdk/ios/symbolication/).
