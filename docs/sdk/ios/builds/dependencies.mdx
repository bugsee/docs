...
A scrollable, sortable, filterable table listing every captured entry. Columns include `id`, `direct`/`transitive`, `type`, ecosystem, and resolved version. Because the same wire schema backs both platforms, this is the [same table as on Android](/sdk/android/v7/builds/dependencies).
