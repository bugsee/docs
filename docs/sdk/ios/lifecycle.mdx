...
Your class should implement the **BugseeDelegate** protocol and it must set itself as the delegate for Bugsee. You should implement the following callback to be notified about lifecycle changes:
