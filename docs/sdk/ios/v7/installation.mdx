...
:::note
6.x option names still work — written as constants or as plain strings, the SDK translates
them. The one exception is `"CaptureVideoAdaptive"`, which is dropped; use
`BugseeOptionCaptureVideoAdaptive`. See
