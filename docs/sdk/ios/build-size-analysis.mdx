...
Bugsee Build Size Analysis turns app size into a first-class CI signal alongside crashes, ANRs, and session replay. It ships in two layers, configured independently, and works on both iOS and Android — this page covers the iOS setup; see the [Android counterpart](/sdk/android/build-size-analysis) for parity.
...
- [Android Build size analysis](/sdk/android/build-size-analysis) — same feature on the Android side; same data model on the server.
