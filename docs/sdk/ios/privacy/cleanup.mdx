...
:::warning
Note that this API does not delete the session-related data, such as [attributes](/sdk/ios/custom/#sessionuser-attributes). To clean those up, use the corresponding API (e.g. `[Bugsee clearAllAttributes]`)
:::
