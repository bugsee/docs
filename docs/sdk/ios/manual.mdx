...
[Bugsee createReportWithCompletion:^(BugseeExtendedReport * report) {
    ...
    [report exportVideoToPath:@"full/video/path.mov" withCompletion:^{
...
and you will be provided with statistics and a breakdown by unique devices, IOS versions, etc.
...
if balance < 0 {
    Bugsee.logAssert(description: "Balance is wrong", location: "\(#function) (\(#file):\(#line))")
}
```
