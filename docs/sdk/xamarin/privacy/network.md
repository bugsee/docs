...
description: "How to disable or filter captured network traffic in Bugsee for Xamarin to redact sensitive data from request and response logs."
sidebar_position: 3
slug: "/sdk/xamarin/privacy/network"
---
...
Network traffic collection can be disabled completely using **MonitorNetwork** launch option. See [configuration](/sdk/xamarin/configuration/) for more info. 
