...
description: "Overview of privacy controls in the Bugsee .NET SDK, covering tools to prevent or sanitize PII in video, console logs, and network reports."
sidebar_position: 0
slug: "/sdk/dotnet/privacy/overview"
---
...
* [Video and Touch](/sdk/dotnet/privacy/video/)
* [Console logs](/sdk/dotnet/privacy/logs/)
* [Network logs](/sdk/dotnet/privacy/network/)
* [Cleanup](/sdk/dotnet/privacy/cleanup/)