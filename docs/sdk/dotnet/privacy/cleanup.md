...
:::warning
Note that this API does not delete the session-related data, such as [attributes](/sdk/dotnet/custom/#usersession-attributes). To clean those up, use the corresponding API (e.g. `Bugsee.ClearAllAttributes()`)
:::
