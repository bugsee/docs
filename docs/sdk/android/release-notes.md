...
- Feat: Add video exporting API to ExtendedReport created via Bugsee.createReport() \[[learn more](/sdk/android/manual/)\]
...
- Feat: New application exit detection feature behind the "DetectAppExit" launch option \[[learn more](/sdk/android/configuration/)\].
...
## 5.2.0 (July 16 2024)
- Feat: New API to delete all captured/collected data on the disk \[[learn more](/sdk/android/privacy/cleanup/)\].
...
- Feat: Add support for Ktor \([learn more](/sdk/android/network/#ktor)\)
...
- Feat: Added new API to handle and filter report fields \([Learn more](/sdk/android/privacy/report/)\)
...
## 1.13.0 (Oct 24 2018)
- Feature: add ability to set launch options via LaunchOptions class [read more](/sdk/android/configuration/)
- Feature: add HandleAnr launch option (experimental) [read more](/sdk/android/configuration/)
- Feature: add new system trace "Carrier"
- Feature: gather more data for "Connection" trace
- Feature: add ability to stop recording for the time when custom report UI is shown [read more](/sdk/android/manual/)
...
- Feature: Add CaptureNetworkAndNetworkNames option for privacy [read more](/sdk/android/configuration/)

## 1.12.0 (Jul 19 2018)
- Feature: Added CaptureDeviceAndNetworkNames launch option for privacy [read more](/sdk/android/configuration/)
...
## 1.11.11 (May 21 2018)
- Feature: Make bugsee notifications customizable [read more](/sdk/android/appearance/)
...
## 1.11.8 (Apr 10 2018)
- Feature: Screen regions can now be hidden by coordinates [read more](/sdk/android/privacy/video/)
...
- Feature: Add VideoScale option for downgrading video quality [read more](/sdk/android/configuration/)
- Various stability fixes

## 1.11.0 (Dec 26 2017)
- Added support for Instant Apps
- View drawing cache became the default way for screen capture (ExtendedVideoMode launch option is *false* by default now) [read more](/sdk/android/configuration/)
- Various stability fixes

## 1.10.0 (Nov 1 2017)
- Added DefaultBugPriority, DefaultCrashPriority, ReportPrioritySelector options [read more](/sdk/android/configuration/)
- Various stability fixes

## 1.9.1 (Oct 12 2017)
- Added 'WifiOnlyUpload' option to allow uploading issues only on WiFi [read more](/sdk/android/configuration/)
...
## 1.8.1 (Aug 02 2017)
- New launch option - MaxDataSize [read more](/sdk/android/configuration/)

## 1.8.0 (Jul 13 2017)
- Feature: User Feedback [read more](/sdk/android/feedback/)
- Various stability fixes
...
- Feature: New experimental video capture method not involving MediaProject and system enforced user consent dialog.
  ...
  option to **false** to disable MediaProjection and switch to the new method. [read more](/sdk/android/configuration/)
- Feature: Crash reporting from services - experimental feature, enabled by **Service** launch flag. [read more](/sdk/android/configuration/)
- Feature: Better handling for low disk space environment
- Various stability fixes

## 1.6.0 (Apr 14 2017)
- Feature: Add Secure views in XML [read more](/sdk/android/privacy/video/)
- Feature: Support for maven builds [read more](/sdk/android/maven-installation/)
- Feature: Charging and Bluetooth system traces added
- Various stability fixes

## 1.5.0 (Mar 03 2017)

- Feature: Proguard support [read more](/sdk/android/crashes/)
...
- Feature: Hidden fields concealment in WebView [read more](/sdk/android/privacy/video/)
- Feature: User attachments [read more](/sdk/android/custom/#file-attachments)
- Various stability fixes
