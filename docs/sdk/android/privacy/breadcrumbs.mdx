...
Beyond the built-in sources, you can record your own breadcrumbs with `Bugsee.addBreadcrumb(...)` — see [Breadcrumbs → Recording custom breadcrumbs](/sdk/android/breadcrumbs#recording-custom-breadcrumbs). Custom breadcrumbs run through the [filter](#filtering-breadcrumbs) you register here, exactly like the built-in ones.
