...
sidebar_position: 2
slug: "/sdk/android/v6/configuration"
---
...
|NdkCrashReport|false|Catch and report application crashes in native code. This is an experimental feature. Care should be taken when using it in production builds. [Learn more](/sdk/android/v6/crashes/) about NDK crashes symbolication and its requirements.|
