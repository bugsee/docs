...
:::warning
Note that this API does not delete the session-related data, such as [attributes](/sdk/android/v6/custom/#usersession-attributes). To cleanup up those, use corresponding API (e.g. `Bugsee.clearAllAttributes()`)
:::
