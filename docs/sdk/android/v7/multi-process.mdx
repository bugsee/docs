---
title: "Multi-process apps (7.x Beta)"
...
sidebar_position: 17
slug: "/sdk/android/v7/multi-process"
---
...
- [Installation — Gradle plugin](/sdk/android/v7/installation) — the recommended setup flow.
- [Installation — Maven / direct](/sdk/android/v7/maven-installation) — when you're not using the Bugsee Gradle plugin.
- [Configuration — Overview](/sdk/android/v7/configuration) — the auto-init manifest keys and the full option surface.
