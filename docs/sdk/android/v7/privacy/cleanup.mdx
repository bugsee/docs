---
title: "Data cleanup (7.x Beta)"
description: "Delete Bugsee's on-device data store and clear session attributes in the Bugsee Android SDK 7.x."
sidebar_position: 7
slug: "/sdk/android/v7/privacy/cleanup"
---
...
[6.x cleanup page](/sdk/android/privacy/cleanup/).
:::
...
such as [user attributes](/sdk/android/v7/custom#user-and-session-attributes).
...
sensitive flow with
[`Bugsee.startBlackout()` / `endBlackout()`](/sdk/android/v7/privacy/video/#blackout--time-bounded-full-redaction)
