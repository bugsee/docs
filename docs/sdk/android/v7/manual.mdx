...
`IssueSeverity` values: `VeryLow`, `Medium`, `High`, `Critical`, `Blocker`. See the [configuration reference — Enums](/sdk/android/v7/configuration#enum-reference) for each value's meaning.
