...
For an overview of how the extension framework works in 7.x (registration, lifecycle, `Bugsee.ext(...)` lookup), see the [Bugsee extensions](/sdk/android/v7/extensibility/bugsee-extensions) page.
