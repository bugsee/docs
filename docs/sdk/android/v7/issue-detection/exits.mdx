...
sidebar_position: 5
slug: "/sdk/android/v7/issue-detection/exits"
---
...
- [Configuration → Detection](/sdk/android/v7/configuration#detection) — the option-key reference for all detection options including the per-reason exit sub-flags.
