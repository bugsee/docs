---
title: "Native crashes — NDK (7.x Beta)"
...
sidebar_position: 3
slug: "/sdk/android/v7/issue-detection/native-crashes"
---
...
Native crash detection is independent of Java/Kotlin obfuscation — Crashpad doesn't see the JVM stack. The matching tombstone (when present) contains a JVM stack trace that **does** need the mapping for full deobfuscation; that's covered by the regular mapping upload — see [Crashes](/sdk/android/v7/issue-detection/crashes#symbolication-and-mapping-uploads).

## See also

- [Configuration → NDK extension](/sdk/android/v7/configuration/ndk) — the option-key reference for the NDK extension.
