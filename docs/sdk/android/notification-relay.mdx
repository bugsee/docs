...
A subscribed webhook receives a relayed notification as the `notification.relayed` event — see [`notification.relayed`](/webhooks/events#notificationrelayed) for its payload.
