...
sidebar_position: 2
slug: "/sdk/android/issue-detection/crashes"
---
...
For native (NDK) crashes — separate detector, separate extension module — see [Native crashes](/sdk/android/issue-detection/native-crashes).
...
- [Configuration → Detection](/sdk/android/configuration#detection) — the option-key reference for all detection options including the crash-related ones.
