...
By default, Bugsee automatically captures view hierarchy upon bug or error report generation. This feature is controlled by the ```ViewHierarchyEnabled``` launch option (Refer to [configuration](/sdk/android/configuration/) section for more details on launch options).
