---
title: "Console logs"
description: "Capturing Logcat output and recording custom log entries with Bugsee Android SDK 7.x, including log filtering via EventFilter<LogEvent>."
sidebar_position: 7
...
This page documents the Bugsee Android SDK **7.x**. For the previous major
