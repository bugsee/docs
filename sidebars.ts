  ...
  docs: [
    {type: 'doc', id: 'index', label: 'Overview'},
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'sdk/ios/build-size-analysis', label: 'Build size analysis'},
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        {type: 'doc', id: 'sdk/android/v7/installation', label: 'Installation'},
        {type: 'doc', id: 'sdk/android/v7/migration', label: 'Migrating from 6.x'},
        {type: 'doc', id: 'sdk/android/v7/maven-installation', label: 'Maven Installation'},
        {type: 'doc', id: 'sdk/android/v7/configuration', label: 'Configuration'},
        ...
        {type: 'doc', id: 'sdk/android/v7/crashes', label: 'Crash reports'},
        {type: 'doc', id: 'sdk/android/v7/detection', label: 'Issue detection'},
        {type: 'doc', id: 'sdk/android/v7/performance', label: 'Performance monitoring'},
        {type: 'doc', id: 'sdk/android/v7/extensions', label: 'Extensions'},
        {type: 'doc', id: 'sdk/android/v7/gradle-plugin', label: 'Gradle plugin'},
        {type: 'doc', id: 'sdk/android/v7/build-size-analysis', label: 'Build size analysis'},
